% EBOLA SCENARIO 1 - FIXED WINDOWS (RICHARDS MODEL)
...
for window = 1:n_windows
    ...
    Run_Forecasting_ODEModel(@options_forecast_RICH_ebola_scenario1, tstart, tstart, calib_size, forecast_horizon);
end

fprintf('\n========================================\n');
fprintf('✓ All RICHARDS fixed window runs completed\n');
