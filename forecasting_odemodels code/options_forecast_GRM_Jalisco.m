...
% Options file for Generalized Richards
...
% Model: Generalized Richards
model.fc = @GRM;  % Function name in toolbox
model.name = 'Generalized Richards model';  % Display name for files/plots
params.label = {'r','p','a','K'};
params.LB = [0.05, 0.05, 0.1, 1000];     % Lower bounds
params.UB = [5, 1, 3, 10000];            % Upper bounds
params.initial = [0.5, 0.5, 0.5, 7500];    % Initial guesse
